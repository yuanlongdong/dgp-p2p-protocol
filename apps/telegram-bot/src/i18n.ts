...
const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "status.reputation": "信誉：买家 {buyer} / 卖家 {seller}｜风险：{risk}",
    "status.riskUnknown": "待同步",
    "status.item": "• 交易 #{id}｜{amount} {token}\n  {buyer} → {seller}\n  状态：{status}{escrowId}{disputeId}",
    "status.escrowInline": "托管映射：{escrowId}",
    "status.disputeInline": "争议映射：{disputeId}",
    "status.refreshed": "状态已刷新",
    "button.pay": "支付",
    "button.release": "释放",
    "button.dispute": "争议",
    "button.status": "状态",
    "button.openMiniApp": "打开 MiniApp",
    "button.backStatus": "返回状态",
    "error.actionUnavailable": "当前状态下该操作不可用。",
    "reminder.payOverdue": "⏰ 交易 #{dealId} 可能逾期未支付，请尽快完成 fundEscrow()。",
    "reminder.voteOverdue": "⏰ 交易 #{dealId} 争议可能临近截止，请尽快在 MiniApp 完成投票。",
    "panel.dealCreated": "👇 当前交易可直接通过下方按钮进入支付或查看状态。",
    "panel.status": "👇 请选择下一步操作。",
  ...
  en: {
    ...
    "status.reputation": "Reputation: buyer {buyer} / seller {seller} | Risk: {risk}",
    "status.riskUnknown": "pending sync",
    "status.item": "• Deal #{id} | {amount} {token}\n  {buyer} → {seller}\n  Status: {status}{escrowId}{disputeId}",
    "status.escrowInline": "Escrow mapping: {escrowId}",
    "status.disputeInline": "Dispute mapping: {disputeId}",
    "status.refreshed": "Status refreshed",
    "button.pay": "Pay",
    "button.release": "Release",
    "button.dispute": "Dispute",
    "button.status": "Status",
    "button.openMiniApp": "Open MiniApp",
    "button.backStatus": "Back to Status",
    "error.actionUnavailable": "This action is not available in the current state.",
    "reminder.payOverdue": "⏰ Deal #{dealId} may be overdue for payment. Please complete fundEscrow() soon.",
    "reminder.voteOverdue": "⏰ Deal #{dealId} dispute voting may be close to expiry. Please vote in MiniApp soon.",
    "panel.dealCreated": "👇 Use the buttons below to continue to payment or check status.",
    "panel.status": "👇 Choose the next action below.",
