...
const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "deal.fundsSecured": "🛡️ 资金由智能合约托管\n🔒 管理员无法触碰资金\n👇 点击下方按钮继续打开托管",
    "pay.title": "💸 交易 #{dealId}\n金额：{amount} {token}\n操作：fundEscrow()\n{binding}\n👇 点击下方按钮继续支付托管",
    "pay.binding.bound": "已绑定 EscrowId：{escrowId}",
    "pay.binding.tip": "提示：可使用 /pay <dealId> <escrowId> 绑定链上映射。",
    "pay.button": "支付托管",
    ...
    "status.item": "• 交易 #{id}｜{amount} {token}\n  {buyer} → {seller}\n  状态：{status}{escrowId}{disputeId}",
    "help.title": "🤖 DGP 托管机器人",
    "help.officialFactory": "官方合约地址：{address}",
    "help.notSet": "未设置",
    "help.secured": "🛡️ 资金由智能合约托管。",
    "help.noAdminAccess": "🔒 管理员无法触碰资金。",
    "help.offline": "🧪 支持离线演示模式（不涉及链上资金）。",
    "help.available": "可用命令：",
    "help.tip": "提示：优先通过按钮进入 MiniApp，可减少手动输入错误。",
    "card.title": "╔════════════ 托管交易 ════════════",
    "card.deal": "║ 交易：#{id}",
    "card.buyer": "║ 买家：@{buyer}",
  ...
  en: {
    ...
    "deal.fundsSecured": "🛡️ Funds are secured by smart contract\n🔒 Admin cannot access funds\n👇 Tap the button below to open the escrow flow",
    "pay.title": "💸 Deal #{dealId}\nAmount: {amount} {token}\nAction: fundEscrow()\n{binding}\n👇 Tap the button below to continue funding the escrow",
    "pay.binding.bound": "Bound EscrowId: {escrowId}",
    "pay.binding.tip": "Tip: use /pay <dealId> <escrowId> to bind the on-chain mapping.",
    ...
    "status.item": "• Deal #{id} | {amount} {token}\n  {buyer} → {seller}\n  Status: {status}{escrowId}{disputeId}",
    "help.title": "🤖 DGP Escrow Bot",
    "help.officialFactory": "Official contract address: {address}",
    "help.notSet": "NOT_SET",
    "help.secured": "🛡️ Funds are secured by smart contract.",
    ...
    "help.tip": "Tip: open actions via MiniApp buttons first to reduce manual input mistakes.",
